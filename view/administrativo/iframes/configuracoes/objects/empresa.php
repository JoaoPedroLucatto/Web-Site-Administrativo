<div class="row">
    <div class="s12 no-padding">
        <div class="s12 inputbox">
            <input type="text" name="nome_empresa" class="browser-default" required autocomplete="off" maxlength="200" value="<?php echo $listar['nome_empresa'] ? $listar['nome_empresa'] : '' ;?>">
            <label>Nome do Empreendimento</label>
        </div>

        <div class="col s12 imagembox" id="upload-imagem">
            <div class="imagem">
                <img id="preview" class="img" <?php echo file_exists($img_logo) ? "src=$img_logo" : "src=$img_logo_default" ;?>>
