<form method="GET" action="../../../../controller/administrativo/iframes/projetos/deletar.php">
    <div class="row">
        <div class="s12">
            <div class="sub-header">
                <a class="title-sub-header"><img src="../../../../images/icons/person_add_black.png">Exclusão de Projetos</a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 iframe-content">
        <div class="row">
            <div class="col s12 no-padding-vertical">
                <span class="text"> Deseja confirmar a exclusão <?php echo count($_GET['row_id']) != 1 ? 'dos Projetos selecionados?' : 'do Projeto selecionado?'; ?></span>
            </div>
            ...
            <div class="col s12">
                ...
                foreach ($_GET['row_id'] as $id) {
                    ...
                    $sql = "SELECT pro.id, pro.titulo, statu.descricao FROM projetos pro INNER JOIN status_registros statu on statu.id = pro.id_statusregistro WHERE pro.id = $id";
