            ...
            <div class="col s12">
                <?php
                    foreach ($_GET['row_id'] as $id) {
                        ...
                        $sql = "SELECT usu.id, usu.nome_completo, usu.login, statu.descricao FROM usuarios usu INNER JOIN status_registros statu on statu.id = usu.id_statusregistro WHERE usu.id = $id";
                        $array_return = true;
