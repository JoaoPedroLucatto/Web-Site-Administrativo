...
<script src="style/js/website/objects/header.js"></script>
<script src="style/js/website/objects/menu.js"></script>
...
<div class="col s12 header">
	...
	<div class="col l8 m12 s12 no-padding menu">
		<a href="#slider" class="item">Home</a>
		<a href="#portfolio" class="item">Portfólio</a>
		<a href="#sobre" class="item">Sobre</a>
		<a href="#contato" class="item">Contato</a>
		<a href="#arearestrita" class="item">Área Restrita</a>
	</div>
</div>
